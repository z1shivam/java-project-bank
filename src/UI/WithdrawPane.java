 ...
 * @author Shivam
 */
public class WithdrawPane extends javax.swing.JFrame {

    /**
     * Creates new form WithdrawInterface
     */
    javax.swing.JFrame prevPane;
    public WithdrawPane(javax.swing.JFrame prevPane) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("withdrawing from -");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         boolean response = api.Withdraw.withdraw(Double.parseDouble(jTextField1.getText()));

        if (response){
             SwingUtilities.invokeLater(() -> {
                javax.swing.JFrame r = new Dialog("Amount " + jTextField1.getText() + " Withdrawed Successfully!!");
                r.setVisible(true);
                r.setTitle("Withdraw Successful!!");
            ...
            SwingUtilities.invokeLater(() -> {
                javax.swing.JFrame r = new Dialog("Not enough balance!!");
                r.setVisible(true);
                r.setTitle("Error!!");
                r.setLocationRelativeTo(null);
            });
